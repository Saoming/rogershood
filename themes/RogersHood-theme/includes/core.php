...
function theme_setup() {
	...
	register_nav_menus(
		array(
			...
			'mobile'         => esc_html__( 'Mobile Header Menu', 'tenup-theme' ),
			'footer_shop'    => esc_html__( 'Footer Menu Shop', 'tenup-theme' ),
			'footer_learn'   => esc_html__( 'Footer Menu Learn', 'tenup-theme' ),
			'footer_connect' => esc_html__( 'Footer Menu Connect', 'tenup-theme' ),
			'footer_general' => esc_html__( 'Footer Menu General', 'tenup-theme' ),
		)
	);
}
 ...
 *
 * Change title to Our Products if it Shop Archive Page
 *
 * @since 2.0.6.
 */
if ( ! function_exists( 'change_woo_title' ) ) {
	function change_woo_title( $page_title ) {
		if ( is_shop() ) {
