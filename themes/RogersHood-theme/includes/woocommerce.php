...
if ( ! in_array( 'woocommerce/woocommerce.php', rh_get_active_plugins(), true ) ) return;
...
function custom_pre_get_posts_query( $q ) {
	...
	if ( ! rh_is_shop() || ! $q->is_main_query() ) return;
	...
	$excluded_cats    = array_filter( $terms, fn( $term ) => in_array( $term->slug, [ 'ebooks', 'uncategorized' ], true ) );
