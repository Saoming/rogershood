		...
		<div class="tiktok-feed__socials-container">
			<?php if ( $facebook_link ) { ?>
				<a href="<?php echo esc_url( $facebook_link ); ?>" class="tiktok-feed__social-link" target="_blank">
					<img src="<?php echo TENUP_THEME_DIST_URL . '/svg/social-icons/facebook.svg'; ?>" alt="Facebook">
				</a>
			<?php }
			if ( $instagram_link ) { ?>
				<a href="<?php echo esc_url( $instagram_link ); ?>" class="tiktok-feed__social-link" target="_blank">
					<img src="<?php echo TENUP_THEME_DIST_URL . '/svg/social-icons/instagram.svg'; ?>" alt="Instagram">
				</a>
			<?php }
			if ( $tiktok_link ) { ?>
