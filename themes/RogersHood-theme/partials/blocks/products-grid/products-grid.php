	...
	<div class="container">
		...
		<div class="row rh-products-grid__row">
			<?php if ( have_rows( 'products' ) ) : while ( have_rows( 'products' ) ) : the_row(); ?>
					...
					?>
				<div class="rh-products-grid__product col-md-4 has-border-radius fc-white text-center " style="background-image: url('<?php echo esc_url($background_image_url); ?>')">
						<?php if($product_name) { ?>
						...
						<?php }
						if($product_cta) { ?>
							<a href="<?php echo esc_url($product_cta_url); ?>" class="rh-products-grid__cta button button-primary" <?php echo esc_attr($product_cta_title); ?>>
