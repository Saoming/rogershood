...
$account_page_url = get_field( 'account_page_url', 'option' ) ?? '#';
$cart_page_url    = get_field( 'cart_page_url', 'option' ) ?? '#';
?>
...
<header role="banner" class="header__container page-container">
	...
	<div class="header__brand">
		<?php if ( $args['header_brand'] ) : ?>
		<a href="<?php echo esc_url( $args['brand_link'] ); ?>" class="header__brand-link">
	...
	<div class="header__woo">
		<a href="<?php echo esc_url( $account_page_url ); ?>" class="header__woo-link">
		...
		<a href="<?php echo esc_url( $cart_page_url ); ?>" class="header__woo-link">
